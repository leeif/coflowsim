...
public abstract class Simulator {
	 ...
	 *
	 * @param sharingAlgo              {@link coflowsim.utils.Constants.SHARING_ALGO} to be used.
	 * @param traceProducer            {@link coflowsim.traceproducers.TraceProducer} to simulate.
	 * @param offline                  whether all coflows/jobs should be forced start together irrespective of their
	 *                                 arrival times.
	 * @param considerDeadline         whether or not to ignore deadlines.
	 * @param deadlineMultRandomFactor multiplier used to generate deadlines.
	 */
	public Simulator(
	 ...
	 * </ul>
	 *
	 * @param EPOCH_IN_MILLIS simulator epoch length in milliseconds
	 */
...
//									(curTime / Constants.SIMULATION_SECOND_MILLIS), numActiveJobs, curJob);
	 ...
	 *
	 * @param j job that has been admitted
	 */
